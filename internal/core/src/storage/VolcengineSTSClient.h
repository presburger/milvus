 ...
 */
class AWS_CORE_API VolcengineSTSCredentialsClient : public AWSHttpResourceClient {
 public:
    /**
    ...
    Aws::String buildJwtToken(const STSAssumeRoleWithWebIdentityRequest& request);
